                                        ...
                                        <form id="eticketform" name="eticketform" action="<?= APPS_URL.'eticket/saveticket'; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" onSubmit="return checkValidationOfEticket()" novalidate>
                                        	<div class="row">
													...
													<div class="row"> 
														...
														<div class="col-12 col-md-8">
															<select class="form-control selectpicker" id="complexity" name="eticket[complexity]" data-live-search="true" required <?= !empty($data['readyonly']) ? $data['readyonly'] : '' ?>>
																...
																<?php
																	foreach(COMPLEXITY as $val){
																		$edit_complexity = !empty($data['edit']['complexity']) && $data['edit']['complexity']==$val ? 'selected' : '';
																		
																		echo '<option data-tokens="'.$val.'" value="'.$val.'" '.$edit_complexity.'>'.$val.'</option>';
																	}
																?>																
															</select>
														</div>
												...
												<div class="form-group col-md-6">
													<div class="row"> 
														...
														<div class="col-12 col-md-8">		
															<div class="input-group">
																<input name="eticket[job_delivery_date]" id="delivery_date" class="form-control datepickersetMin" placeholder="dd-mm-yyyy" type="text" <?= !empty($data['readyonly']) ? $data['readyonly'] : '' ?> value="<?= !empty($data['edit']['job_delivery_date']) ? date('d-m-Y', strtotime($data['edit']['job_delivery_date'])) : '' ?>" autocomplete="off">
																<div class="input-group-addon">
																	<i class="material-icons">date_range</i>
																</div>
															</div>				
                                            ...
                                            <div class="row <?php if(!empty($data['edit']['is_escalated']) && $data['edit']['is_escalated']=='Y'){ echo ''; }else{ echo 'hide'; } ?>" id="escalateComment">                                 
												<div class="form-group col-md-6">
													<div class="row"> 
														<div class="col col-md-4 text-right">
															<label for="escalation_type" class="form-control-label mt-2">Escalation Type<sup class="danger">*</sup></label>
														</div>
														<div class="col-12 col-md-8">
                                            ...
                                            <div class="row">                                 
												<div class="form-group offset-6">
													...
													<input name="submit_eticket" title="Delete" id="submit_eticket" type="submit" class="btn btn-lg btn-info" value="<?= !empty($data['edit']['id']) && !isset($data['rejected_id']) ? 'Update' : 'Submit' ?>">
												</div>
                                       		</div>
                                        </form>
                                    </div> 
